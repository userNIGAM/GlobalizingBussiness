            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <motion.button
                  ...
                  type="button"
                  className="p-6 border-2 border-gray-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 text-left focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => {
                    setUserType('jobProvider');
                    setErrors({});
                  }}
                  type="button"
                  className="p-6 border-2 border-gray-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50 transition-all duration-200 text-left focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="bg-indigo-100 p-2 rounded-lg">
                      <Briefcase className="w-6 h-6 text-indigo-600" />
                    </div>
                    <h3 className="font-semibold text-gray-900">Job Provider</h3>
                  </div>
                  <p className="text-sm text-gray-600">
                    I want to post jobs and hire
                  </p>
                </motion.button>
              </div>
            </div>
