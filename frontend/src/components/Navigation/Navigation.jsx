...
import RightIcons from "./Navigation/RightIcons";
import MobileMenu from "./Navigation/MobileMenu";
import { ThemeContext } from "../context/ThemeContext";
import SearchModal from "./Navigation/SearchModal";

const Navigation = ({ activeTab, setActiveTab, searchQuery, setSearchQuery }) => {
    ...
    <>
      <nav
        ...
        className={`${isDark ? "bg-gray-900/95" : "bg-white/95"} ${
          scrolled
            ? isDark
              ? "backdrop-blur-lg bg-gray-900/90 shadow-xl"
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            <div className="flex items-center flex-1 md:flex-none">
              <LogoSection isDark={isDark} setActiveTab={setActiveTab} />
