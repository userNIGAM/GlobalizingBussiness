...
import { X, Image, Video, FileText, MapPin, Globe, Smile } from 'lucide-react';
...
export default function CreatePostModal({ isOpen, onClose, onSubmit }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-hidden border border-gray-200">
        {/* Header */}
        ...
        <div className="p-6 flex items-start gap-4">
          <Avatar src="https://api.dicebear.com/7.x/avataaars/svg?seed=You" size="lg" />
          <div>
        ...
        <div className="px-6 pb-6">
          <textarea
            ...
            className="w-full min-h-50 p-4 resize-none focus:outline-none text-lg bg-gray-50 rounded-2xl border border-gray-200 focus:border-purple-500"
            rows={4}
          />
          ...
          {imageUrl && (
            <div className="mt-4 relative group">
              <img src={imageUrl} alt="Preview" className="w-full rounded-xl max-h-64 object-cover" />
              <button
                onClick={() => setImageUrl('')}
          ...
          <button
            ...
            className="mt-6 w-full py-4 bg-linear-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-xl hover:from-purple-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg hover:shadow-xl"
          >
            Publish Post
          </button>
        </div>
