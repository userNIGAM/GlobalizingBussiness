...
export default function Jobs() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-purple-50 via-blue-50 to-indigo-50 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            <div className="flex items-center justify-center mb-8">
              <div className="relative">
                <div className="w-24 h-24 bg-linear-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
            ...
            <div className="grid grid-cols-4 gap-4 mb-8">
              {[
                ...
                <div key={item.label} className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-gray-900 bg-linear-to-br from-purple-100 to-blue-100 py-4 rounded-xl mb-2">
                    {item.value}
                  </div>
          ...
          <div>
            ...
            {/* Testimonial */}
            <div className="mt-12 bg-linear-to-br from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
